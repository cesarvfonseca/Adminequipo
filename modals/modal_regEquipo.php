							...
							<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-sm-6">
										...
										<input class="form-control" placeholder="Nombre encargado" name="p_nombre" required>
									</div>
									<div class="col-sm-6">
										<label for="p_ape">Apellidos</label>
										<input type="text" class="form-control" placeholder="Apellido encargado" name="p_ape" required>
									</div>
								</div>
								<!-- Puesto -->
								<div class="form-group">
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" placeholder="Ingrese Puesto del encargado" name="p_puesto" required title="Completa este campo">
									</div>

									<div class="col-sm-6">
										<label for="p_correo">Correo</label>
										<input type="email" class="form-control" placeholder="Ingrese Email del encargado" name="p_correo" required>
									</div>
								</div>
								<!-- Sucursal -->
								<div class="form-group">
						...
						<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<input type="text" class="form-control" placeholder="Proveedor" name="e_proveedor" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<label for="e_procesador">Procesador</label>
										<input type="text" class="form-control" placeholder="Procesador" name="e_procesador" required>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
